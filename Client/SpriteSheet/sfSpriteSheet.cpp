...
sfSpriteSheet::sfSpriteSheet(std::string const& path, int nbAnim, int nbFrame) : window_(sfmlWin), nbAnim_(nbAnim), nbFrame_(nbFrame), currentFrame_(0)
{
...
bool	sfSpriteSheet::playAnimation(int anim)
{
